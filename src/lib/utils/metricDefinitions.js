export const metricDefinitions = {
    ...
    wowy_rapm: 'Daily-grain synthetic RAPM estimate built consistently across every season since 1979-80. Historical dates use a modest hindsight refinement to sharpen career arcs.',
