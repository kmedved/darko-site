export const metricDefinitions = {
    ...
    wowy_rapm: 'Synthetic game-level RAPM estimate built consistently across every season since 1979-80.',
    wowy_orapm: 'Synthetic offensive RAPM estimate. Offensive and defensive attribution is less stable than total impact.',
    wowy_drapm: 'Synthetic defensive RAPM estimate, where positive values mean better defense. Offensive and defensive attribution is less stable than total impact.',
